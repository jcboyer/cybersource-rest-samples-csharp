...
namespace Cybersource_rest_samples_dotnet.Samples.Webhooks.ManageWebhooks
{
	...
	{
		public static ResponseType Run(string webhookId)
		{
			...
			var requestObj = new ReplayWebhooks(
			...
			try
			{
				...
				ResponseType result = apiInstance.ReplayPreviousWebhook(webhookId, requestObj);
